...
class MultiTaskPerceptionModel(nn.Module):
    def __init__(self, num_breeds : int   = 37, 
        ...
        if download:
            ...
            # gdown.download(id="10mUDbxmT3yluEjjeLfUUefCTlQdsLk8H", output=localizer_path, quiet=False) # will still work
            gdown.download(id="1THGvIUDOnQyfWt5KRqWbPaYCzSsHbQza", output=localizer_path, quiet=False) # retrain
